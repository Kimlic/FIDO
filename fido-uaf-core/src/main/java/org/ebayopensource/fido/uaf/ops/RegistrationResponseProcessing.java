...
//	}
    ...
    private RegistrationRecord processAssertions(
        ...
        try {
            ...
            authRecord.account_address = record.account_address;
    ...
    private void verifyAttestationSignature(Tags tags, RegistrationRecord record) throws Exception {
    ...
    private void checkServerData(String serverDataB64, RegistrationRecord[] records) throws Exception {
        if (notary == null)
            return;
    ...
    private void setUsernameAndTimeStamp(String username, String timeStamp,
        ...
        for (int i = 0; i < records.length; i++) {
            ...
            rec.account_address = new String(Base64.decodeBase64(username));
